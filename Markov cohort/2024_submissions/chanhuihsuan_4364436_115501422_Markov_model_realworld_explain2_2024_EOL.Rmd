...
p_matrix <- array(data = c(1 - tpProg - tpDn, 0, 0,
                           ...
                           tpProg*(1-effect), 1 - tpDcmd - tpDn, 0,
                           tpDn, tpDcmd + tpDn, 1),
...
p_matrix_cycle <- function(p_matrix, age, cycle,
  ...
  p_matrix["Progressive_disease", "Dead", "with_drug"] <- tpDcmd + tpDn
  p_matrix["Progressive_disease", "Progressive_disease", "with_drug"] <- 1 - tpDcmd - tpDn
